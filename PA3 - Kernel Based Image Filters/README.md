This assignment is a kernel-based image filter, allowing users to process images and apply one of three filters (Sobel Kernel, Gaussian Blur, Unsharp Mask). 
